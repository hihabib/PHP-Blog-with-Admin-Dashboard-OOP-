<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <!-- Dashboard -->
        <li class="menu-item <?php echo $mainMenu  == "Dashboard" ? "active" : ""; ?>">
        ...
        <li class="menu-item <?php echo $mainMenu  == "Category" ? "active open" : ""; ?>">
            ...
            <ul class="menu-sub">
                <li class="menu-item <?php echo $subMenu  == "All Caregories" ? "active" : ""; ?>">
                    <a href="all-categories.php" class="menu-link">
